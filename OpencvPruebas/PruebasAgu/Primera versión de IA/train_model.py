...
def train(train_file, val_file, epochs=50, batch_size=32):
    ...
    if len(train_dataset) == 0:
        print("\n" + "="*60)
        print("✗ ERROR: No hay muestras de entrenamiento válidas")
        print("="*60)
        print("\nLos archivos referenciados en las anotaciones no existen.")
        print("Necesitas regenerar las anotaciones para los archivos en tiles/")
        print("\nOpciones:")
        print("1. Usa annotation_tool.py o annotation_tool_letters.py")
        print("2. Verifica que los archivos de imagen existen en la carpeta tiles/")
        return False
    
    if len(val_dataset) == 0:
        print("\n⚠️  ADVERTENCIA: No hay muestras de validación")
        print("El entrenamiento continuará sin validación\n")
